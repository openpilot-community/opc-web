Trestle.admin(:dashboard) do
  menu do
    ...
    group :resources do
      item :discord, '/discord', label: "<span class=\"fa\"><img src=\"https://img.icons8.com/color/180/discord-new-logo.png\" style=\"width: 44px;position:absolute;left:18px;top:3px;\" /></span> <span style=\"color:#FFFFFF;padding-left:15px;\"><strong>Discord</strong></span>&nbsp;&nbsp;<span style=\"padding-left: 48px;font-size: 12px;display:block;font-weight: 400;\">Get help or just chat!</span>".html_safe, icon: "fa fa-discord", priority: 1.40
      item :reddit, 'https://www.reddit.com/r/openpilotcommunity/', label: "<span class=\"fa\"><img src=\"https://external-preview.redd.it/QJRqGgkUjhGSdu3vfpckrvg1UKzZOqX2BbglcLhjS70.png?auto=webp&s=c681ae9c9b5021d81b6c4e3a2830f09eff2368b5\" style=\"width: 38px;position:absolute;left:18px;top:4px;\" /></span> <span style=\"color:#FFFFFF;padding-left:15px;\"><strong>Reddit</strong></span>&nbsp;&nbsp;<span style=\"padding-left: 48px;font-size: 12px;display:block;font-weight: 400;\">Subscribe to our subreddit!</span>".html_safe, icon: "fa fa-discord", priority: 1.42
      item :workbench, '/workbench', label: "<span class=\"fa\"><img src=\"https://opc.ai/assets/workbench-icon-f733d1c9b5e50e4165cbe8e72c6919391e766bfb276da0f4642530e6d6f539cc.png\" style=\"width: 40px;position:absolute;left:18px;top:4px;\" /></span> <span style=\"color:#FFFFFF;padding-left:15px;\"><strong>Workbench</strong></span><span style=\"padding-left: 48px;font-size: 12px;display:block;font-weight: 400;\">Download our tool for managing EON!</span>".html_safe, icon: "fa fa-download", priority: 1.44
    ...
    group :admin do
      item :releases, '/releases', icon: "fa fa-github", priority: 6.5
      item :release_features, '/release_features', icon: "fa fa-github", priority: 6.56
