Trestle.resource(:guide_images) do
...
instance.guide_id = params['guide_id']
  ...
  form(dialog:true) do |guide_image|
    ...
    fields_for :image, guide_image.image || guide_image.build_image do
  ...
  #
  # params do |params|
  #   params.require(:guide_image).permit(:name, ...)
  # end
end
